...
<section class="home">
   ...
   <div class="swiper-wrapper">
      ...
      <div class="swiper-slide slide">
         <div class="image">
            <img src="images/pc frot.png" alt="">
         </div>
         <div class="content">
            <span>Upto 50% Off</span>
            <h3>Latest pc</h3>
            <a href="category.php?category=pc" class="btn">Shop Now</a>
         </div>
      </div>

      <div class="swiper-slide slide">
         <div class="image">
            <img src="images\keybord_clean.png" alt="">
         </div>
         <div class="content">
            <span>Upto 50% off</span>
            <h3>Latest Keyboard</h3>
            <a href="category.php?category=Keyboard" class="btn">Shop Now.</a>
         </div>
      </div>
...
<section class="category">
   ...
   <a href="category.php?category=Webcam" class="swiper-slide slide">
      <img src="images/web-camp.jpg" alt="">
      <h3>web-camp</h3>
   </a>
   ...
   <a href="category.php?category=Keyboard" class="swiper-slide slide">
      <img src="images/keybord1.jpg" alt="">
      <h3>keyboard</h3>
   </a>
   ...
   <a href="category.php?category=motherbord" class="swiper-slide slide">
      <img src="images/Motherbord.jpg" alt="">
      <h3>Motherbord</h3>
   </a>
...
<section class="home-products">
   ...
   ?>
   <form action="home.php" method="post" class="swiper-slide slide">
