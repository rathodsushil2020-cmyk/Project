...
if(isset($_POST['update_qty'])){
   $cart_id = filter_var($_POST['cart_id'], FILTER_SANITIZE_NUMBER_INT);
   $qty = isset($_POST['qty']) ? filter_var($_POST['qty'], FILTER_SANITIZE_NUMBER_INT) : 1;
...
<section class="products shopping-cart">
   ...
   <form action="" method="post" class="box">
      ...
      <div class="flex">
         ...
         <input type="number" name="qty" class="qty" min="1" max="99" value="<?= htmlspecialchars($fetch_cart['quantity']); ?>">
         <button type="submit" class="fas fa-edit" name="update_qty"></button>
      </div>
      <div class="sub-total"> Sub Total : <span>Rs.<?= htmlspecialchars($sub_total); ?>/-</span> </div>
